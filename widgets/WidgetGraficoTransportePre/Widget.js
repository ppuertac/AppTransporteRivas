  ...
  function(declare, BaseWidget,FeatureLayer, DynamicLayer, Toogle, Gauge, dom, QueryTask, Query, Legend, lang) {
    ...
    return declare([BaseWidget], {
      ...
      startup: function() {
        ...
        console.log('cajaHTML',this.cajaGauge.innerHTML)
        ...
        queryTask.execute(consulta, lang.hitch(this,function(consultado){
          ...
          console.log(consultado)
            ...
            //Calculamos poblacion con acceso a buses
            ...
            var miGauge = new Gauge(gaugeParams, this.cajaGauge)
            // miGauge.set("value", 2)
        
        
            miGauge.startup()

            this.porcentajePoblacion.innerHTML = "<b>" + "<u>" + ((poblacionAccesoBus / maxValue)*100).toFixed(2) + " %" + "</u>" + "</b>" + ' de población con acceso actualmente'
            ...
            console.log('accesoBici', poblacionAccesoBici)
            ...
            var miGaugeBici = new Gauge(gaugeParamsBici, this.cajaGaugeBicis)
            // miGauge.set("value", 2)
        
        
            miGaugeBici.startup()

            this.porcentajePoblacionBicis.innerHTML = "<b>" + "<u>" + ((poblacionAccesoBici / maxValue)*100).toFixed(2) + " %" + "</u>" + "</b>" + ' de población con acceso actualmente'
